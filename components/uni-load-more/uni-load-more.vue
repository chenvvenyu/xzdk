<template>
	<view class="uni-load-more">
		...
		<text :style="{ color: color }" class="uni-load-more__text">
			{{ status === 'more' ? contentText.contentdown : status === 'loading' ? contentText.contentrefresh : status === 'noMore' ? contentText.contentnomore : contentText.contentnodata }}
		</text>
	</view>
</template>
		...
		props: {
			...
			contentText: {
				...
				default () {
					return {
						contentdown: '上拉显示更多喔',
						contentrefresh: '正在加载哟...',
						contentnomore: '已经到底啦',
						contentnodata: '暂时没有您要的哦',
					}
				}
			}
		},
